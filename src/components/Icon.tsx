...
const PATHS = {
  ...
  egg: ['M12 3.5c3.6 0 6.5 5.3 6.5 10a6.5 6.5 0 0 1-13 0c0-4.7 2.9-10 6.5-10Z', 'M9.5 14a2.5 2.5 0 0 0 2.5 2.5'],
  fish: [
  ...
  veggie: ['M5 19C5 10.5 10.5 5 19 5c0 8.5-5.5 14-14 14Z', 'M5 19l9-9', 'M9.5 14.5V11', 'M9.5 14.5H13'],
  pasta: [
  ...
  bread: ['M6 20v-8.6A4 4 0 0 1 8 4h8a4 4 0 0 1 2 7.4V20H6Z', 'M10 9.5l-1 1.5', 'M14 9.5l-1 1.5', 'M12 13.5l-1 1.5'],
  potato: [
  ...
  plate: ['M4 12a8 8 0 1 0 16 0 8 8 0 0 0-16 0Z', 'M9 12a3 3 0 1 0 6 0 3 3 0 0 0-6 0Z'],
...
export default function Icon({ name, className = 'h-5 w-5', strokeWidth = 1.8 }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"

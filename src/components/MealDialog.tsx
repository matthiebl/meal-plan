...
import { addMeal, archiveMeal, updateMeal } from '../data/mutations'
        ...
        <div className="shrink-0 border-b border-line px-4 pt-2.5 pb-3 md:pt-3">
          ...
          <div className="grid grid-cols-[1fr_auto_1fr] items-center">
            <button
              type="button"
              onClick={onClose}
              className="justify-self-start py-1 text-sm text-ink-3 hover:text-ink"
            >
              Cancel
            </button>
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 pt-4 pb-[calc(1.25rem+env(safe-area-inset-bottom))] md:pb-5">
          <div className="flex items-center gap-3 rounded-2xl bg-surface-1 p-2">
            ...
            <div className="min-w-0 flex-1">
              <p
                className={`truncate text-[15px] font-medium ${name.trim() ? '' : 'text-ink-3'}`}
              >
                {name.trim() || 'Meal name'}
              </p>
          ...
          <div>
            ...
            <div className="flex items-center gap-3.5">
              ...
              <output
                aria-live="polite"
                className="min-w-5 text-center text-lg font-medium tabular-nums"
              >
                {servings}
              </output>
              <button
